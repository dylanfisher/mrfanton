...
History.pushState({state:"home"},"Home",Fanton.homeUrl),a("body").addClass("closing").removeClass("single-project-loaded"),a("html").addClass("transitioning"),a("#ajax-wrapper").transition({x:a(window).width()},b,c,function(){a("#ajax-wrapper").empty().css("transform",""),a("body").removeClass("closing"),a("html").removeClass("transitioning")}),a(".home__post-title-wrapper.active .home__post-image").transition({x:"0%"},b,c,function(){a("html").removeClass("transitioning"),a(".home__post-title-wrapper .home__post-image").css("transform","")}),a(".home__post-title-wrapper").removeClass("active"),Fanton.removeColorScheme()}),a(document).on("click",".information-link",function(d){var e=a(this).closest(".information-link-wrapper"),f=a(this).attr("href"),g="Information";e.addClass("active"),a("html").addClass("transitioning"),History.pushState({stateUrl:f},g,f),e.transition({y:"-100vh"},b,c,function(){a("html").removeClass("transitioning"),a("body").addClass("information-open")}),d.preventDefault()}),a(document).on("click",".information__close-button",function(){History.pushState({state:"home"},"Home",Fanton.homeUrl);var d=a(this).closest(".information-link-wrapper");d.removeClass("active"),a("html").addClass("transitioning"),d.transition({y:"0"},b,c,function(){a("html").removeClass("transitioning"),a("body").removeClass("information-open")})})}(jQuery),Fanton.setSinglePost=function(){console.log("Fanton.setSinglePost"),Fanton.state.data.stateUrl=window.location.href},Fanton.removeColorScheme=function(){$("body").removeClass(function(a,b){return(b.match(/(^|\s)color-scheme--\S+/g)||[]).join(" ")})},Fanton.setColorScheme=function(){Fanton.removeColorScheme();var a=$("[data-color-scheme]").attr("data-color-scheme");$("body").addClass("color-scheme--"+a)};