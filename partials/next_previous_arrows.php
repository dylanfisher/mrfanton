<?php
  if( get_adjacent_post(false, '', false) ) {
    echo '<span class="control-button previous-button">';
      next_post_link('<span class="previous-button__post-name next-prev-button__post-name">%link</span><span class="next-previous-button__post-label">'.get_template_part('images/svg/left-arrow.svg').'</span>');
    echo '</span>';
  } else {
  ...
  if( get_adjacent_post(false, '', true) ) {
    echo '<span class="control-button next-button">';
      previous_post_link('<span class="next-button__post-name next-prev-button__post-name">%link</span><span class="next-previous-button__post-label">'.get_template_part('images/svg/right-arrow.svg').'</span>');
    echo '</span>';
  } else {
